...
S1 = 10; 
net = newff(minmax(alphabet),[S1 S2],{'logsig' 'logsig'},'traingdx'); % -> traingdx busca los pesos optimos por metodo del gradiente descendente con derivadas parciales
...
for noiselevel = noise_range 
  ...
  for i=1:max_test 
    P = alphabet + randn(45000,2)*noiselevel; 
  ...
  network1 = [network1 errors1/2/100]; 
  network2 = [network2 errors2/2/100]; 
end 
echo on 
